    ...
    <header className="sticky top-0 z-50 bg-light-100">
      ...
      >
        ...
        >
          ...
          {/* Top Line */}
          <span
            className={`block absolute h-0.5 w-6 bg-dark-900 transition-all duration-300 ${
          ...
          <span
            className={`block absolute h-0.5 w-6 bg-dark-900 transition-all duration-300 top-3 ${
